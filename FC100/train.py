...
class DTrainer:
    ...
    def load_data(self):
        ...
        if self.dataset == "FC100":
            train_dataset = l2l.vision.datasets.FC100(root='./dataset',
                                                      mode='train',
                                                      download=False,
                                                      transform=transform_train)
            valid_dataset = l2l.vision.datasets.FC100(root='./dataset',
                                                      mode='validation',
                                                      download=False,
                                                      transform=transform_validation)
            test_dataset = l2l.vision.datasets.FC100(root='./dataset',
                                                     mode='test',
                                                     download=False,
